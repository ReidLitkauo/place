...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ \"react\");\n/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _common_AnimatedComponent_coffee__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../_common/AnimatedComponent.coffee */ \"./source/public/_common/AnimatedComponent.coffee\");\n/* harmony import */ var _common_ComponentAnimationManager_coffee__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../_common/ComponentAnimationManager.coffee */ \"./source/public/_common/ComponentAnimationManager.coffee\");\n/* harmony import */ var _common_Globals_coffee__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../_common/Globals.coffee */ \"./source/public/_common/Globals.coffee\");\n/* harmony import */ var _CoordinateSpaceConverter_coffee__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./CoordinateSpaceConverter.coffee */ \"./source/public/index/script/MainCanvas/CoordinateSpaceConverter.coffee\");\n/* harmony import */ var _MouseEventHandler_coffee__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./MouseEventHandler.coffee */ \"./source/public/index/script/MainCanvas/MouseEventHandler.coffee\");\n/* harmony import */ var _TransformCalculator_coffee__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./TransformCalculator.coffee */ \"./source/public/index/script/MainCanvas/TransformCalculator.coffee\");\n/* harmony import */ var _CanvasReticule_CanvasReticule_coffee__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./CanvasReticule/_CanvasReticule.coffee */ \"./source/public/index/script/MainCanvas/CanvasReticule/_CanvasReticule.coffee\");\nvar MainCanvas,\n    boundMethodCheck = function (instance, Constructor) {\n  if (!(instance instanceof Constructor)) {\n    throw new Error('Bound instance method accessed before binding');\n  }\n};\n\n\n\n\n\n\n\n\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (MainCanvas = function () {\n  class MainCanvas extends _common_AnimatedComponent_coffee__WEBPACK_IMPORTED_MODULE_1__[\"default\"] {\n    constructor(props) {\n      super(props);\n      this._computeAnimationStyle = this._computeAnimationStyle.bind(this);\n      this.getBoundingBox = this.getBoundingBox.bind(this);\n      this.render = this.render.bind(this);\n      this.canvasPosition = props.canvasPosition;\n      this.coordinateSpaceConverter = new _CoordinateSpaceConverter_coffee__WEBPACK_IMPORTED_MODULE_4__[\"default\"](this.getBoundingBox);\n      this.mouseEventHandler = new _MouseEventHandler_coffee__WEBPACK_IMPORTED_MODULE_5__[\"default\"](this.canvasPosition, this.getBoundingBox);\n    }\n\n    _computeAnimationStyle() {\n      boundMethodCheck(this, MainCanvas);\n      return {\n        transform: _TransformCalculator_coffee__WEBPACK_IMPORTED_MODULE_6__[\"default\"].getTransformStyle(this.props.canvasPosition.getRaw())\n      };\n    }\n\n    getBoundingBox() {\n      var borderThickness, rawBoundingBox, zoomScale;\n      boundMethodCheck(this, MainCanvas);\n\n      if (!document.getElementById(this.id)) {\n        return {\n          x: 0,\n          y: 0,\n          width: 1,\n          height: 1\n        };\n      }\n\n      zoomScale = this.props.canvasPosition.getRaw().zoomScale;\n      rawBoundingBox = document.getElementById(this.id).getBoundingClientRect();\n      borderThickness = zoomScale * parseFloat(getComputedStyle(document.getElementById('main-canvas'))['border-width']);\n      return {\n        // The raw bounding box includes the large grey border around the canvas.\n        // Remove that border from the bounding box used in calculations.\n        x: rawBoundingBox.x + borderThickness,\n        y: rawBoundingBox.y + borderThickness,\n        width: rawBoundingBox.width - 2 * borderThickness,\n        height: rawBoundingBox.height - 2 * borderThickness\n      };\n    }\n\n    render() {\n      boundMethodCheck(this, MainCanvas);\n      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(\"div\", {\n        id: this.id + '-parent'\n      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(\"canvas\", {\n        id: this.id,\n        width: _common_Globals_coffee__WEBPACK_IMPORTED_MODULE_3__[\"default\"].BOARD_SIDE_LENGTH_IN_TILES,\n        height: _common_Globals_coffee__WEBPACK_IMPORTED_MODULE_3__[\"default\"].BOARD_SIDE_LENGTH_IN_TILES,\n        onMouseDown: this.mouseEventHandler.onMouseDown,\n        onMouseMove: this.mouseEventHandler.onMouseMove,\n        onMouseUp: this.mouseEventHandler.onMouseUp,\n        onWheel: this.mouseEventHandler.onWheel,\n        ref: this.ref\n      }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_CanvasReticule_CanvasReticule_coffee__WEBPACK_IMPORTED_MODULE_7__[\"default\"], {\n        canvasPosition: this.canvasPosition,\n        coordinateSpaceConverter: this.coordinateSpaceConverter\n      }));\n    }\n\n  }\n\n  ;\n  MainCanvas.prototype.id = 'main-canvas';\n  return MainCanvas;\n}.call(undefined));\n\n//# sourceURL=webpack:///./source/public/index/script/MainCanvas/_MainCanvas.coffee?");
